...
if (strcmp($error, 'desactive') == 0) {
    ?>
    <section class="problem_section layout_padding">
        <center>
            <p>Ce compte est désactivé.</p>
...
if (strcmp($error, 'mdp non changé') == 0) {
    ?>
    <div class="container">
        <center><p>L'ancien mot de passe entré n'était pas correct, le mot de passe n'a pas pu être changé, veuillez réessayer.</p>
    </div>
    <?php
}
